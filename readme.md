# OpenTrade cryptocurrency exchange!
...
curl -sL https://raw.githubusercontent.com/nvm-sh/nvm/v0.37.2/install.sh -o install_nvm.sh
bash install_nvm.sh
[sudo] reboot
...
exports.walletspassphrase = {
    'FREAK' : 'LONG_RANDOM_STRING2',
    'MENTX' : 'LONG_RANDOM_STRING3',
...
```
./FreakChaind encryptwallet random_long_string_SAME_AS_IN_FILE_private_constants.js

```
*If coin has "coin-cli" file then try something like "coin-cli" instead*
